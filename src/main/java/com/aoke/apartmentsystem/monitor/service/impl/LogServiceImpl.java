...
public class LogServiceImpl extends ServiceImpl<LogMapper, Log> implements ILogService {
    ...
    public void saveLog(ProceedingJoinPoint point, Log log) throws JsonProcessingException {
        ...
        com.aoke.apartmentsystem.common.annotation.Log logAnnotation = method.getAnnotation(com.aoke.apartmentsystem.common.annotation.Log.class);

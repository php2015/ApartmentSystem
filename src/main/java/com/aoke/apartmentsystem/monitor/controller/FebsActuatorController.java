...
import com.aoke.apartmentsystem.monitor.endpoint.FebsHttpTraceEndpoint;
import com.aoke.apartmentsystem.monitor.entity.FebsHttpTrace;
...
import static com.aoke.apartmentsystem.monitor.endpoint.FebsHttpTraceEndpoint.FebsHttpTraceDescriptor;
...
public class FebsActuatorController {
    ...
    Logger log = LoggerFactory.getLogger(FebsActuatorController.class);

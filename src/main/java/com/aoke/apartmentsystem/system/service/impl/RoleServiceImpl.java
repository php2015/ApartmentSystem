...
import com.aoke.apartmentsystem.system.mapper.RoleMapper;
import com.aoke.apartmentsystem.system.service.IRoleMenuService;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements IRoleService {
    ...
    public IPage<Role> findRoles(Role role, QueryRequest request) {
        Page<Role> page = new Page<Role>(request.getPageNum(), request.getPageSize());

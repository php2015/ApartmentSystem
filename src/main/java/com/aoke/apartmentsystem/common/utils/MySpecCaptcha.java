...
public class MySpecCaptcha extends MyCaptcha {

    public MySpecCaptcha() {
    }

    public MySpecCaptcha(int width, int height) {
        this();
        setWidth(width);
        setHeight(height);
    }

    public MySpecCaptcha(int width, int height, int len) {
        this(width, height);
        setLen(len);
    }

    public MySpecCaptcha(int width, int height, int len, Font font) {

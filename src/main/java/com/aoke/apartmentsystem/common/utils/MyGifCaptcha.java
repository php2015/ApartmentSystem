...
import com.wf.captcha.GifEncoder;
...
public class MyGifCaptcha extends MyCaptcha {

    public MyGifCaptcha() {
    }

    public MyGifCaptcha(int width, int height) {
        setWidth(width);
        setHeight(height);
    }

    public MyGifCaptcha(int width, int height, int len) {
        this(width, height);
        setLen(len);
    }

    public MyGifCaptcha(int width, int height, int len, Font font) {

package com.aoke.apartmentsystem.job.util;

import com.aoke.apartmentsystem.common.utils.SpringContextUtil;
import com.aoke.apartmentsystem.job.entity.Job;
import com.aoke.apartmentsystem.job.entity.JobLog;
import com.aoke.apartmentsystem.job.service.IJobLogService;
...
public class ScheduleJob extends QuartzJobBean {
    ...
    Logger log = LoggerFactory.getLogger(ScheduleJob.class);
